...
@property (nonatomic, getter = isEditable) BOOL editable; // FIXME: should be private
@property (nonatomic, readonly, copy) BBUProgressHandler progressHandler;
@property (nonatomic) BOOL showFailure; // FIXME: should be private
@property (nonatomic) BOOL showSuccess; // FIXME: should be private
