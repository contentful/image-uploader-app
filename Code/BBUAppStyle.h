...
@property (nonatomic, readonly) NSColor* informationColor;
@property (nonatomic, readonly) NSColor* lightBackgroundColor;
@property (nonatomic, readonly) NSColor* primaryButtonColor;
